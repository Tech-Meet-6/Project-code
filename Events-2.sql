...
CREATE TABLE `Events` (
  `id` int(11) NOT NULL,
  `event_tittle` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `Events` (`id`, `event_tittle`, `event_link`, `event_information`, `event_type`, `date`, `created`, `modified`, `status`) VALUES
